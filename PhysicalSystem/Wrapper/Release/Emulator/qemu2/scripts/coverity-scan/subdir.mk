...
C_SRCS += \
../Emulator/qemu2/scripts/coverity-scan/model.c 

C_DEPS += \
./Emulator/qemu2/scripts/coverity-scan/model.c.d 

LINK_OBJ += \
./Emulator/qemu2/scripts/coverity-scan/model.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/scripts/coverity-scan/model.c.o: ../Emulator/qemu2/scripts/coverity-scan/model.c
	@echo 'Building file: $<'
