...
C_SRCS += \
../Emulator/qemu2/target/riscv/tcg/tcg-cpu.c 

C_DEPS += \
./Emulator/qemu2/target/riscv/tcg/tcg-cpu.c.d 

LINK_OBJ += \
./Emulator/qemu2/target/riscv/tcg/tcg-cpu.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/target/riscv/tcg/tcg-cpu.c.o: ../Emulator/qemu2/target/riscv/tcg/tcg-cpu.c
	@echo 'Building file: $<'
