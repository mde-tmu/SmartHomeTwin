...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/xtensa/trax/test/test.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/xtensa/trax/test/test.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/xtensa/trax/test/test.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/xtensa/trax/test/test.c.o: ../Emulator/qemu2/esp-idf/components/xtensa/trax/test/test.c
	@echo 'Building file: $<'
