...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/esp_http_server/src/util/ctrl_sock.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/esp_http_server/src/util/ctrl_sock.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/esp_http_server/src/util/ctrl_sock.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/esp_http_server/src/util/ctrl_sock.c.o: ../Emulator/qemu2/esp-idf/components/esp_http_server/src/util/ctrl_sock.c
	@echo 'Building file: $<'
