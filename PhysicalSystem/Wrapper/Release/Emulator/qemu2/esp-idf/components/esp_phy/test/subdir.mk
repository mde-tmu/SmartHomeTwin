...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/esp_phy/test/test_phy_rtc.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/esp_phy/test/test_phy_rtc.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/esp_phy/test/test_phy_rtc.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/esp_phy/test/test_phy_rtc.c.o: ../Emulator/qemu2/esp-idf/components/esp_phy/test/test_phy_rtc.c
	@echo 'Building file: $<'
