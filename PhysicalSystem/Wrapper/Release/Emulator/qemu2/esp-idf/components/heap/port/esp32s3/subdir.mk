...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/heap/port/esp32s3/memory_layout.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/heap/port/esp32s3/memory_layout.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/heap/port/esp32s3/memory_layout.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/heap/port/esp32s3/memory_layout.c.o: ../Emulator/qemu2/esp-idf/components/heap/port/esp32s3/memory_layout.c
	@echo 'Building file: $<'
