...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/ports/win32/check/time.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/ports/win32/check/time.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/ports/win32/check/time.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/ports/win32/check/time.c.o: ../Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/ports/win32/check/time.c
	@echo 'Building file: $<'
