...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/examples/example_app/test.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/examples/example_app/test.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/examples/example_app/test.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/examples/example_app/test.c.o: ../Emulator/qemu2/esp-idf/components/lwip/lwip/contrib/examples/example_app/test.c
	@echo 'Building file: $<'
