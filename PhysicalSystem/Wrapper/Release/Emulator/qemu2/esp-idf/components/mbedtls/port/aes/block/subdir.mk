...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/mbedtls/port/aes/block/esp_aes.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/mbedtls/port/aes/block/esp_aes.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/mbedtls/port/aes/block/esp_aes.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/mbedtls/port/aes/block/esp_aes.c.o: ../Emulator/qemu2/esp-idf/components/mbedtls/port/aes/block/esp_aes.c
	@echo 'Building file: $<'
