...
C_SRCS += \
../Emulator/qemu2/esp-idf/components/app_trace/port/riscv/port.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/components/app_trace/port/riscv/port.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/components/app_trace/port/riscv/port.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/components/app_trace/port/riscv/port.c.o: ../Emulator/qemu2/esp-idf/components/app_trace/port/riscv/port.c
	@echo 'Building file: $<'
