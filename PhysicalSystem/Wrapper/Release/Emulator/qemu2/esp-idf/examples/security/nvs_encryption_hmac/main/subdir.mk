...
C_SRCS += \
../Emulator/qemu2/esp-idf/examples/security/nvs_encryption_hmac/main/main.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/examples/security/nvs_encryption_hmac/main/main.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/examples/security/nvs_encryption_hmac/main/main.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/examples/security/nvs_encryption_hmac/main/main.c.o: ../Emulator/qemu2/esp-idf/examples/security/nvs_encryption_hmac/main/main.c
	@echo 'Building file: $<'
