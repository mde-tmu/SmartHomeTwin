...
C_SRCS += \
../Emulator/qemu2/esp-idf/examples/wifi/wps_softap_registrar/main/wps.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/examples/wifi/wps_softap_registrar/main/wps.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/examples/wifi/wps_softap_registrar/main/wps.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/examples/wifi/wps_softap_registrar/main/wps.c.o: ../Emulator/qemu2/esp-idf/examples/wifi/wps_softap_registrar/main/wps.c
	@echo 'Building file: $<'
