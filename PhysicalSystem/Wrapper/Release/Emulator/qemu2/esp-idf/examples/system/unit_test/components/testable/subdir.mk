...
C_SRCS += \
../Emulator/qemu2/esp-idf/examples/system/unit_test/components/testable/mean.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/examples/system/unit_test/components/testable/mean.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/examples/system/unit_test/components/testable/mean.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/examples/system/unit_test/components/testable/mean.c.o: ../Emulator/qemu2/esp-idf/examples/system/unit_test/components/testable/mean.c
	@echo 'Building file: $<'
