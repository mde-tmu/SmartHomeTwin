...
C_SRCS += \
../Emulator/qemu2/esp-idf/examples/network/eth2ap/main/ethernet_example_main.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/examples/network/eth2ap/main/ethernet_example_main.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/examples/network/eth2ap/main/ethernet_example_main.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/examples/network/eth2ap/main/ethernet_example_main.c.o: ../Emulator/qemu2/esp-idf/examples/network/eth2ap/main/ethernet_example_main.c
	@echo 'Building file: $<'
