...
C_SRCS += \
../Emulator/qemu2/esp-idf/examples/protocols/modbus/serial/mb_slave/main/slave.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/examples/protocols/modbus/serial/mb_slave/main/slave.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/examples/protocols/modbus/serial/mb_slave/main/slave.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/examples/protocols/modbus/serial/mb_slave/main/slave.c.o: ../Emulator/qemu2/esp-idf/examples/protocols/modbus/serial/mb_slave/main/slave.c
	@echo 'Building file: $<'
