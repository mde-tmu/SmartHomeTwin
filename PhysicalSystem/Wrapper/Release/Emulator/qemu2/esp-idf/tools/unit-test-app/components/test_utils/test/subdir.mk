...
C_SRCS += \
../Emulator/qemu2/esp-idf/tools/unit-test-app/components/test_utils/test/leak_test.c 

C_DEPS += \
./Emulator/qemu2/esp-idf/tools/unit-test-app/components/test_utils/test/leak_test.c.d 

LINK_OBJ += \
./Emulator/qemu2/esp-idf/tools/unit-test-app/components/test_utils/test/leak_test.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu2/esp-idf/tools/unit-test-app/components/test_utils/test/leak_test.c.o: ../Emulator/qemu2/esp-idf/tools/unit-test-app/components/test_utils/test/leak_test.c
	@echo 'Building file: $<'
