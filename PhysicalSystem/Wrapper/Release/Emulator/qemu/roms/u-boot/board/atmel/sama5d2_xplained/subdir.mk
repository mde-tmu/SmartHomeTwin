...
C_SRCS += \
../Emulator/qemu/roms/u-boot/board/atmel/sama5d2_xplained/sama5d2_xplained.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/board/atmel/sama5d2_xplained/sama5d2_xplained.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/board/atmel/sama5d2_xplained/sama5d2_xplained.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/board/atmel/sama5d2_xplained/sama5d2_xplained.c.o: ../Emulator/qemu/roms/u-boot/board/atmel/sama5d2_xplained/sama5d2_xplained.c
	@echo 'Building file: $<'
