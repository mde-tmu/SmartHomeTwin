...
C_SRCS += \
../Emulator/qemu/roms/u-boot/board/Marvell/db-mv784mp-gp/db-mv784mp-gp.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/board/Marvell/db-mv784mp-gp/db-mv784mp-gp.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/board/Marvell/db-mv784mp-gp/db-mv784mp-gp.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/board/Marvell/db-mv784mp-gp/db-mv784mp-gp.c.o: ../Emulator/qemu/roms/u-boot/board/Marvell/db-mv784mp-gp/db-mv784mp-gp.c
	@echo 'Building file: $<'
