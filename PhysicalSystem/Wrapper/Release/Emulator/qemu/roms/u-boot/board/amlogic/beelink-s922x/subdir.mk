...
C_SRCS += \
../Emulator/qemu/roms/u-boot/board/amlogic/beelink-s922x/beelink-s922x.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/board/amlogic/beelink-s922x/beelink-s922x.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/board/amlogic/beelink-s922x/beelink-s922x.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/board/amlogic/beelink-s922x/beelink-s922x.c.o: ../Emulator/qemu/roms/u-boot/board/amlogic/beelink-s922x/beelink-s922x.c
	@echo 'Building file: $<'
