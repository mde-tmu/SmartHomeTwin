...
C_SRCS += \
../Emulator/qemu/roms/u-boot/board/emulation/qemu-x86/qemu-x86.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/board/emulation/qemu-x86/qemu-x86.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/board/emulation/qemu-x86/qemu-x86.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/board/emulation/qemu-x86/qemu-x86.c.o: ../Emulator/qemu/roms/u-boot/board/emulation/qemu-x86/qemu-x86.c
	@echo 'Building file: $<'
