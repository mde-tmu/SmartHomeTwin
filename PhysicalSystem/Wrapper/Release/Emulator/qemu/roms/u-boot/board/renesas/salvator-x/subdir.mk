...
C_SRCS += \
../Emulator/qemu/roms/u-boot/board/renesas/salvator-x/salvator-x.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/board/renesas/salvator-x/salvator-x.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/board/renesas/salvator-x/salvator-x.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/board/renesas/salvator-x/salvator-x.c.o: ../Emulator/qemu/roms/u-boot/board/renesas/salvator-x/salvator-x.c
	@echo 'Building file: $<'
