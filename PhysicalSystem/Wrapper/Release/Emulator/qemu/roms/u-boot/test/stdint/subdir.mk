...
C_SRCS += \
../Emulator/qemu/roms/u-boot/test/stdint/int-types.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/test/stdint/int-types.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/test/stdint/int-types.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/test/stdint/int-types.c.o: ../Emulator/qemu/roms/u-boot/test/stdint/int-types.c
	@echo 'Building file: $<'
