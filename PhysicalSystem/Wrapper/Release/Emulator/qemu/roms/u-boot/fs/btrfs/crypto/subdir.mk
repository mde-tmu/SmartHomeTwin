...
C_SRCS += \
../Emulator/qemu/roms/u-boot/fs/btrfs/crypto/hash.c 

C_DEPS += \
./Emulator/qemu/roms/u-boot/fs/btrfs/crypto/hash.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/u-boot/fs/btrfs/crypto/hash.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/u-boot/fs/btrfs/crypto/hash.c.o: ../Emulator/qemu/roms/u-boot/fs/btrfs/crypto/hash.c
	@echo 'Building file: $<'
