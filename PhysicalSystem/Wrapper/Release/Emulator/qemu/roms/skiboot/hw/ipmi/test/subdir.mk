...
C_SRCS += \
../Emulator/qemu/roms/skiboot/hw/ipmi/test/run-fru.c 

C_DEPS += \
./Emulator/qemu/roms/skiboot/hw/ipmi/test/run-fru.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/skiboot/hw/ipmi/test/run-fru.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/skiboot/hw/ipmi/test/run-fru.c.o: ../Emulator/qemu/roms/skiboot/hw/ipmi/test/run-fru.c
	@echo 'Building file: $<'
