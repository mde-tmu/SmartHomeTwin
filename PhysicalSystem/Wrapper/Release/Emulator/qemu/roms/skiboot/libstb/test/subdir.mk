...
C_SRCS += \
../Emulator/qemu/roms/skiboot/libstb/test/run-stb-container.c 

C_DEPS += \
./Emulator/qemu/roms/skiboot/libstb/test/run-stb-container.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/skiboot/libstb/test/run-stb-container.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/skiboot/libstb/test/run-stb-container.c.o: ../Emulator/qemu/roms/skiboot/libstb/test/run-stb-container.c
	@echo 'Building file: $<'
