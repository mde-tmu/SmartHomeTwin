...
C_SRCS += \
../Emulator/qemu/roms/skiboot/ccan/list/list.c 

C_DEPS += \
./Emulator/qemu/roms/skiboot/ccan/list/list.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/skiboot/ccan/list/list.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/skiboot/ccan/list/list.c.o: ../Emulator/qemu/roms/skiboot/ccan/list/list.c
	@echo 'Building file: $<'
