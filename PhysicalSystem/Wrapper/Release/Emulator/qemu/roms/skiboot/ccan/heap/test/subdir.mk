...
C_SRCS += \
../Emulator/qemu/roms/skiboot/ccan/heap/test/run.c 

C_DEPS += \
./Emulator/qemu/roms/skiboot/ccan/heap/test/run.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/skiboot/ccan/heap/test/run.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/skiboot/ccan/heap/test/run.c.o: ../Emulator/qemu/roms/skiboot/ccan/heap/test/run.c
	@echo 'Building file: $<'
