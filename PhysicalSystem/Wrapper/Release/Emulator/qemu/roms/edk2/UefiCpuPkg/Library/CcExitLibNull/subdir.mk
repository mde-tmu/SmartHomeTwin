...
C_SRCS += \
../Emulator/qemu/roms/edk2/UefiCpuPkg/Library/CcExitLibNull/CcExitLibNull.c 

C_DEPS += \
./Emulator/qemu/roms/edk2/UefiCpuPkg/Library/CcExitLibNull/CcExitLibNull.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/edk2/UefiCpuPkg/Library/CcExitLibNull/CcExitLibNull.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/edk2/UefiCpuPkg/Library/CcExitLibNull/CcExitLibNull.c.o: ../Emulator/qemu/roms/edk2/UefiCpuPkg/Library/CcExitLibNull/CcExitLibNull.c
	@echo 'Building file: $<'
