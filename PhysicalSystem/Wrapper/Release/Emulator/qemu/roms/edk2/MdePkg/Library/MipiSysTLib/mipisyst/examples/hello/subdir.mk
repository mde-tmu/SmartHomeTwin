...
C_SRCS += \
../Emulator/qemu/roms/edk2/MdePkg/Library/MipiSysTLib/mipisyst/examples/hello/hello.c 

C_DEPS += \
./Emulator/qemu/roms/edk2/MdePkg/Library/MipiSysTLib/mipisyst/examples/hello/hello.c.d 

LINK_OBJ += \
./Emulator/qemu/roms/edk2/MdePkg/Library/MipiSysTLib/mipisyst/examples/hello/hello.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/roms/edk2/MdePkg/Library/MipiSysTLib/mipisyst/examples/hello/hello.c.o: ../Emulator/qemu/roms/edk2/MdePkg/Library/MipiSysTLib/mipisyst/examples/hello/hello.c
	@echo 'Building file: $<'
