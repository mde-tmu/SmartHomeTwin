...
C_SRCS += \
../Emulator/qemu/target/riscv/tcg/tcg-cpu.c 

C_DEPS += \
./Emulator/qemu/target/riscv/tcg/tcg-cpu.c.d 

LINK_OBJ += \
./Emulator/qemu/target/riscv/tcg/tcg-cpu.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/target/riscv/tcg/tcg-cpu.c.o: ../Emulator/qemu/target/riscv/tcg/tcg-cpu.c
	@echo 'Building file: $<'
