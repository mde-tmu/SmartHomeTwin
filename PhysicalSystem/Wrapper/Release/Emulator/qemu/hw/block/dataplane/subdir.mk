...
C_SRCS += \
../Emulator/qemu/hw/block/dataplane/xen-block.c 

C_DEPS += \
./Emulator/qemu/hw/block/dataplane/xen-block.c.d 

LINK_OBJ += \
./Emulator/qemu/hw/block/dataplane/xen-block.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/hw/block/dataplane/xen-block.c.o: ../Emulator/qemu/hw/block/dataplane/xen-block.c
	@echo 'Building file: $<'
