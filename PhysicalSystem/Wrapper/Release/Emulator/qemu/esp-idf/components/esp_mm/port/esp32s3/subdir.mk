...
C_SRCS += \
../Emulator/qemu/esp-idf/components/esp_mm/port/esp32s3/ext_mem_layout.c 

C_DEPS += \
./Emulator/qemu/esp-idf/components/esp_mm/port/esp32s3/ext_mem_layout.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/components/esp_mm/port/esp32s3/ext_mem_layout.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/components/esp_mm/port/esp32s3/ext_mem_layout.c.o: ../Emulator/qemu/esp-idf/components/esp_mm/port/esp32s3/ext_mem_layout.c
	@echo 'Building file: $<'
