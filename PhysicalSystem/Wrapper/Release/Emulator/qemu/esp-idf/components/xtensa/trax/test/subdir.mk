...
C_SRCS += \
../Emulator/qemu/esp-idf/components/xtensa/trax/test/test.c 

C_DEPS += \
./Emulator/qemu/esp-idf/components/xtensa/trax/test/test.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/components/xtensa/trax/test/test.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/components/xtensa/trax/test/test.c.o: ../Emulator/qemu/esp-idf/components/xtensa/trax/test/test.c
	@echo 'Building file: $<'
