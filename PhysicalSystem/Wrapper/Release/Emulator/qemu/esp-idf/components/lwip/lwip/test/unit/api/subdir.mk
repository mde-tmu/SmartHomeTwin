...
C_SRCS += \
../Emulator/qemu/esp-idf/components/lwip/lwip/test/unit/api/test_sockets.c 

C_DEPS += \
./Emulator/qemu/esp-idf/components/lwip/lwip/test/unit/api/test_sockets.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/components/lwip/lwip/test/unit/api/test_sockets.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/components/lwip/lwip/test/unit/api/test_sockets.c.o: ../Emulator/qemu/esp-idf/components/lwip/lwip/test/unit/api/test_sockets.c
	@echo 'Building file: $<'
