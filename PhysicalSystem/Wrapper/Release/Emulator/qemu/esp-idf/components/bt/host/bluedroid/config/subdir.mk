...
C_SRCS += \
../Emulator/qemu/esp-idf/components/bt/host/bluedroid/config/stack_config.c 

C_DEPS += \
./Emulator/qemu/esp-idf/components/bt/host/bluedroid/config/stack_config.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/components/bt/host/bluedroid/config/stack_config.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/components/bt/host/bluedroid/config/stack_config.c.o: ../Emulator/qemu/esp-idf/components/bt/host/bluedroid/config/stack_config.c
	@echo 'Building file: $<'
