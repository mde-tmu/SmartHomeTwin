...
C_SRCS += \
../Emulator/qemu/esp-idf/examples/peripherals/i2s/i2s_basic/i2s_tdm/main/i2s_tdm_example_main.c 

C_DEPS += \
./Emulator/qemu/esp-idf/examples/peripherals/i2s/i2s_basic/i2s_tdm/main/i2s_tdm_example_main.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/examples/peripherals/i2s/i2s_basic/i2s_tdm/main/i2s_tdm_example_main.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/examples/peripherals/i2s/i2s_basic/i2s_tdm/main/i2s_tdm_example_main.c.o: ../Emulator/qemu/esp-idf/examples/peripherals/i2s/i2s_basic/i2s_tdm/main/i2s_tdm_example_main.c
	@echo 'Building file: $<'
