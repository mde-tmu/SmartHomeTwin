...
C_SRCS += \
../Emulator/qemu/esp-idf/examples/system/gcov/components/sample/some_funcs.c 

C_DEPS += \
./Emulator/qemu/esp-idf/examples/system/gcov/components/sample/some_funcs.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/examples/system/gcov/components/sample/some_funcs.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/examples/system/gcov/components/sample/some_funcs.c.o: ../Emulator/qemu/esp-idf/examples/system/gcov/components/sample/some_funcs.c
	@echo 'Building file: $<'
