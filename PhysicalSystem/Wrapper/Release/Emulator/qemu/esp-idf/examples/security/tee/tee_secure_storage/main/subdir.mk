...
C_SRCS += \
../Emulator/qemu/esp-idf/examples/security/tee/tee_secure_storage/main/tee_main.c 

C_DEPS += \
./Emulator/qemu/esp-idf/examples/security/tee/tee_secure_storage/main/tee_main.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/examples/security/tee/tee_secure_storage/main/tee_main.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/examples/security/tee/tee_secure_storage/main/tee_main.c.o: ../Emulator/qemu/esp-idf/examples/security/tee/tee_secure_storage/main/tee_main.c
	@echo 'Building file: $<'
