...
C_SRCS += \
../Emulator/qemu/esp-idf/examples/wifi/scan/main/scan.c 

C_DEPS += \
./Emulator/qemu/esp-idf/examples/wifi/scan/main/scan.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/examples/wifi/scan/main/scan.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/examples/wifi/scan/main/scan.c.o: ../Emulator/qemu/esp-idf/examples/wifi/scan/main/scan.c
	@echo 'Building file: $<'
