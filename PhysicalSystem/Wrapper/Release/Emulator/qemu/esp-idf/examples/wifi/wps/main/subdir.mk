...
C_SRCS += \
../Emulator/qemu/esp-idf/examples/wifi/wps/main/wps.c 

C_DEPS += \
./Emulator/qemu/esp-idf/examples/wifi/wps/main/wps.c.d 

LINK_OBJ += \
./Emulator/qemu/esp-idf/examples/wifi/wps/main/wps.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/esp-idf/examples/wifi/wps/main/wps.c.o: ../Emulator/qemu/esp-idf/examples/wifi/wps/main/wps.c
	@echo 'Building file: $<'
