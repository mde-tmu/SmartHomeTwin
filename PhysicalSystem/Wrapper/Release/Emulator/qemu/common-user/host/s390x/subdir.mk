...
S_UPPER_SRCS += \
../Emulator/qemu/common-user/host/s390x/safe-syscall.inc.S 

LINK_OBJ += \
./Emulator/qemu/common-user/host/s390x/safe-syscall.inc.S.o 

S_UPPER_DEPS += \
./Emulator/qemu/common-user/host/s390x/safe-syscall.inc.S.d 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/common-user/host/s390x/safe-syscall.inc.S.o: ../Emulator/qemu/common-user/host/s390x/safe-syscall.inc.S
	@echo 'Building file: $<'
