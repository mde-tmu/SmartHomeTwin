...
C_SRCS += \
../Emulator/qemu/tests/tcg/minilib/printf.c 

C_DEPS += \
./Emulator/qemu/tests/tcg/minilib/printf.c.d 

LINK_OBJ += \
./Emulator/qemu/tests/tcg/minilib/printf.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/tests/tcg/minilib/printf.c.o: ../Emulator/qemu/tests/tcg/minilib/printf.c
	@echo 'Building file: $<'
