...
C_SRCS += \
../Emulator/qemu/tests/tcg/aarch64_be/hello.c 

C_DEPS += \
./Emulator/qemu/tests/tcg/aarch64_be/hello.c.d 

LINK_OBJ += \
./Emulator/qemu/tests/tcg/aarch64_be/hello.c.o 


# Each subdirectory must supply rules for building sources it contributes
Emulator/qemu/tests/tcg/aarch64_be/hello.c.o: ../Emulator/qemu/tests/tcg/aarch64_be/hello.c
	@echo 'Building file: $<'
