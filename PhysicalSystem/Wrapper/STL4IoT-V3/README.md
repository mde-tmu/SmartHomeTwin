...
Zenan Zha B.Sc.
## Main Github Webpage
[Click here to visit the main webpage](https://mde-tmu.github.io/STL4IoT/) (Needs update, but Still useful.)

## Installation

0. You must install Java JDK + IDE (Intellij).
...
```bash
git clone https://github.com/mde-tmu/STL4IoT.git
```
3. Open the project with Intellij.
4. Open Itemis Create -> File -> Import... -> General -> Existing Project into Workspace -> Next.
5. Browse & Select the folder "iot-sc-template-library" from STL4IoT.
