...
public class DashboardFrame_Editor extends JFrame{
	...
	public static JPanel smartFirePanel, smartFirePanel_button;
	public static JPanel smartTVPanel;
	public static JPanel smartLightPanel;
	public static JPanel smartMicrowavePanel;
	public static JPanel smartGarageDoorPanel;
    
    public static JButton smartFire_switch, smartFire_snooze,
    				...
    				smartGarageDoor_switch, smartGarageDoor_use, smartGarageDoor_block,
    				notifsViewButton,
	...
	public static JTextPane smartFire_message, smartFire_systemStatus, smartFire_flameSensor, smartFire_smokeSensor, smartFire_heatSensor,
						smartTV_message, smartTV_heat,
						smartLight_message, smartLight_heat,
						smartMicrowave_message, smartMicrowave_heat,
						smartGarageDoor_message, smartGarageDoor_heat,
						notifsText1, notifsText2, notifsText3, notifsText4, notifsText5,
    ...
    public String sf_switch, sf_message, sf_sensors,
    				...
    				sgd_switch, sgd_message, sgd_heat;
    ...
    private final String[] borderConstraints = {
	...
	protected void init() {
		...
		this.createContents();
		this.createSmartFireSystemContents();
		this.createSmartTVSystemContents();
		this.createSmartLightSystemContents();
		this.createSmartMicrowaveSystemContents();
		this.createSmartGarageDoorSystemContents();
	}
    ...
    public void createContents() {
        ...
        frame = new JFrame("Smart Hub System v2.1");
        ...
        mainPanel.setBorder(BorderFactory.createTitledBorder("Smart Hub System v2.1"));
        ...
        /*3*/contentPane.add(DataPlotter.createChartPanel()); //Chart for Consumption Level
        
        ///*4*/contentPane.add(DataPlotter.createBarGraph());
        ///*5*/contentPane.add(createTVPanel());
        /*6*/contentPane.add(DataPlotter.createDialPlot()); //Chart for Consumption Level
    ...
    //SMART FIRE SYSTEM WINDOW
    public void createSmartFireSystemContents() {

        frame = new JFrame("Smart Fire System");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        JPanel contentPane = new JPanel(
                        new GridLayout(0, 1, hGap, hGap));
        contentPane.setBorder(BorderFactory.createEmptyBorder(hGap, vGap, hGap, vGap));
        mainPanel = new JPanel(new BorderLayout(hGap, vGap));
        mainPanel.setBorder(BorderFactory.createTitledBorder("Smart Fire System"));
        mainPanel.setOpaque(true);
        mainPanel.setBackground(Color.WHITE);
...
//        /*4*/contentPane.add(DataPlotter.createBarGraph());
    ...
    //SMART TV SYSTEM WINDOW
    public void createSmartTVSystemContents() {

        frame = new JFrame("Smart TV System");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    //SMART LIGHT SYSTEM WINDOW
    public void createSmartLightSystemContents() {

        frame = new JFrame("Smart Lights HUB System");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    //SMART MICROWAVE SYSTEM WINDOW
    public void createSmartMicrowaveSystemContents() {

        frame = new JFrame("Smart Microwave System");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    public void createSmartGarageDoorSystemContents() {

        frame = new JFrame("Smart Garage Door System");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        JPanel contentPane = new JPanel(
                        new GridLayout(0, 1, hGap, hGap));
        contentPane.setBorder(BorderFactory.createEmptyBorder(hGap, vGap, hGap, vGap));
        contentPane.add(createGarageDoorPanel());
    ...
    public Component createFireAlarmPanel() {
        // Smart Fire
        smartFirePanel = new JPanel(new GridLayout(2, 1, hGap, vGap));
        smartFirePanel_button = new JPanel(new GridLayout(1, 1, hGap, vGap));
        smartFirePanel_button.setBorder(BorderFactory.createEmptyBorder(hGap, vGap, hGap, vGap));

        smartFirePanel_button.setOpaque(true);
        smartFirePanel_button.setBackground(Color.WHITE);
//        smartFirePanel.setOpaque(true);
//        smartFirePanel.setBackground(Color.GRAY.brighter());
//
        smartFire_switch = new JButton();
        smartFire_snooze = new JButton();
//        smartFire_message = new JTextPane();
//        smartFire_systemStatus = new JTextPane();
//        smartFire_smokeSensor = new JTextPane();
//        smartFire_flameSensor = new JTextPane();
//        smartFire_heatSensor = new JTextPane();
//
//
        smartFirePanel_button.add(smartFire_switch);
        smartFirePanel_button.add(smartFire_snooze);
        smartFirePanel.add(smartFirePanel_button);
        smartFirePanel.add(DataPlotter.createBarGraph());
//        smartFirePanel.add(smartFire_systemStatus);
//        smartFirePanel.add(smartFire_smokeSensor);
//        smartFirePanel.add(smartFire_flameSensor);
//        smartFirePanel.add(smartFire_heatSensor);
    ...
    public Component createLightPanel() {
        ...
        JSlider smartLight_led1 = new JSlider();
        smartLight_led1.setFocusable(true);
        JSlider smartLight_led2 = new JSlider();
        smartLight_led2.setFocusable(true);
        ...
        smartLightPanel.add(smartLight_led1);
        smartLightPanel.add(smartLight_led2);
    ...
    //Smart Garage Door Panel
    public Component createGarageDoorPanel() {
        /***********/
        smartGarageDoorPanel = new JPanel(new GridLayout(3, 1, hGap, vGap));
        smartGarageDoorPanel.setBorder(BorderFactory.createEmptyBorder(hGap, vGap, hGap, vGap));
        smartGarageDoorPanel.setOpaque(true);
        smartGarageDoorPanel.setBackground(Color.gray.brighter());
        //BUTTONS
        smartGarageDoor_switch = new JButton();
        smartGarageDoor_use = new JButton();
        smartGarageDoor_block = new JButton();
        smartGarageDoor_use.setText("Garage Door: Door Closed");
        //ADD TO PANEL
        smartGarageDoorPanel.add(smartGarageDoor_switch);
        smartGarageDoorPanel.add(smartGarageDoor_use);
        smartGarageDoorPanel.add(smartGarageDoor_block);
        
        return smartGarageDoorPanel;
    }
    ...
    public Component createTesterPanel1() {
        ...
        testButton2.setText("Test Flame Sensor");
