...
public class Sensor_Component_Fire implements ITimed, IEventDriven {
	public enum State {
	...
	protected boolean getIsExecuting() {
		synchronized(Sensor_Component_Fire.this) {
			return isExecuting;
		}
	}
	...
	public Sensor_Component_Fire() {
		...
		/* Default init sequence for statechart Sensor_Component_Fire */
	...
	public synchronized void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart Sensor_Component_Fire */
	...
	public synchronized void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart Sensor_Component_Fire */
	...
	*/
	...
	protected void raiseUnderThreshold() {
		synchronized(Sensor_Component_Fire.this) {
			underThreshold = true;
			underThresholdObservable.next(null);
		}
	}
	
	private Observable<Void> underThresholdObservable = new Observable<Void>();
	
	public Observable<Void> getUnderThreshold() {
		return underThresholdObservable;
	}
	
	private boolean overThreshold;
	
	
	protected void raiseOverThreshold() {
		synchronized(Sensor_Component_Fire.this) {
			overThreshold = true;
			overThresholdObservable.next(null);
		}
	}
	
	private Observable<Void> overThresholdObservable = new Observable<Void>();
	
	public Observable<Void> getOverThreshold() {
		return overThresholdObservable;
	}
	...
	public synchronized long getTestData() {
		synchronized(Sensor_Component_Fire.this) {
			return testData;
		}
	}
	
	public void setTestData(long value) {
		synchronized(Sensor_Component_Fire.this) {
			this.testData = value;
		}
	}
